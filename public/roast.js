...
module.exports = function (kindOfRoast, arrayOfPlayers) {
  ...
  let leagueRoasts = [
    ...
    "You are so bad at League of Legends that you make the game look bad. You are the worst player I have ever seen and you should probably just give up. - your Mom",
    "You are terrible at League of Legends. You can't even last hit a minion. You're so bad, I'd rather have your mom on my team.",
    ...
    "I know you're doing your best but please stop, I want to win."
  ...
  let compare2Players = [
    ...
    `${winner}, you did ok i guess... hey, ${secondPlace}, what's it like finding something else you're bad at?`,
  ...
  let compare4Players = [
    ...
    `Bro, ${winner} did ${thirdPlace}, ${fourthPlace} so dirty they need ${secondPlace} to hose them off on the side of the house!`,
